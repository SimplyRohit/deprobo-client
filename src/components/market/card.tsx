...
export default function MarketCard({
  ...
  return (
    <Fragment>
      <Card className="relative w-full max-w-[350px] min-h-[400px] p-6 bg-white shadow-lg rounded-lg flex flex-col justify-between">
        <div>
          ...
          <h1 className="flex text-lg w-full">
            {market.account.question.length > 30
              ? market.account.question.slice(0, 26) + "..."
          ...
          <div className="mb-4">
            <div className="flex justify-between text-xs mb-2">
              ...
              <span>
                No: {noUsers} bettors ({formatSol(market.account.totalNo)} SOL)
              </span>
            </div>
          ...
          {!isAuthority && (
            <div>
              ...
              <div className="flex space-x-2">
                <Button
                  onClick={() => handleBet(betAmount, false, market.publicKey)}
                  className="w-full bg-red-500 hover:bg-red-600 text-white rounded-md"
                >
                  NO
                </Button>
                <Button
                  onClick={() => handleBet(betAmount, true, market.publicKey)}
